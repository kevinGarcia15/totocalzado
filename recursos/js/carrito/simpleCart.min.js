(function (p, f) {
  ...
  C = function (q) {
    ...
    b.extend({
      ...
      add: function (a, d) {
        ...
        g = !0,
        u = !0 === d ? d : !1;
        if (!u && (g = b.trigger('beforeAdd', [
          c
        ]), !1 === g)) return !1;
        (g = b.has(c)) ? (g.increment(c.quantity()), c = g)  : r[c.id()] = c;
        b.update();
        u || b.trigger('afterAdd', [
          c,
          e(g)
        ]);
        return c
    ...
    b.extend({
      writeCart: function (a) {
        ...
        w.append(d);
        c = 0;
        for (h = m.cartColumns.length; c < h; c += 1) f = E(m.cartColumns[c]),
      ...
      createCartRow: function (a, d, c, g, u) {
        ...
        u.append(d);
        u = 0;
        for (c = m.cartColumns.length; u < c; u += 1) e = E(m.cartColumns[u]),
    ...
    b.Item = function (a) {
      function d() {
        k(c.price, s) && (c.price = parseFloat(c.price.replace(b.currency().decimal, '.').replace(/[^0-9\.]+/gi, '')));
      ...
      n += 1;
      for (c.id = c.id || 'SCI-' + n; !e(r[c.id]); ) n += 1,
      c.id = 'SCI-' + n;
      g.get = function (a, b) {
        var d = !b;
    ...
    b.extend({
      checkout: function () {
        if ('custom' === m.checkout.type.toLowerCase() && h(m.checkout.fn)) m.checkout.fn.call(b, m.checkout);
          ...
          a.data && a.action && a.method && !1 !== b.trigger('beforeCheckout', [
            a.data
    ...
    b.extendCheckout({
      PayPal: function (a) {
        ...
        b.each(function (a, c) {
          ...
          d['item_codigo_' + g] = a.get('codigo');
          d['item_size_' + g] = a.get('size');
          d['item_img_' + g] = a.get('img');
      ...
      GoogleCheckout: function (a) {
        ...
        b.each(function (a, c) {
          ...
          d['item_codigo_' + e] = a.get('codigo');
          d['item_size_' + e] = a.get('size');
          d['item_img_' + e] = a.get('img');
      ...
      AmazonPayments: function (a) {
        ...
        b.each(function (c, g) {
          ...
          d['item_codigo_' + e] = c.get('codigo');
          d['item_size_' + e] = c.get('size');
          d['item_img_' + e] = c.get('img');
    ...
    f.addEventListener ? p.DOMContentLoaded = function () {
     ...
     : f.attachEvent && (p.DOMContentLoaded = function () {
      ...
      if (f.addEventListener) f.addEventListener('DOMContentLoaded', DOMContentLoaded, !1),
  ...
  function s(e, k) {
    ...
    switch (typeof l) {
      ...
      case 'object':
        ...
        if (q && 'object' === typeof q) for (p = q.length, t = 0; t < p; t += 1) 'string' === typeof q[t] && (n = q[t], (r = s(n, l)) && v.push(f(n) + (h ? ': ' : ':') + r));
         else for (n in l) Object.prototype.hasOwnProperty.call(l, n) && (r = s(n, l)) && v.push(f(n) + (h ? ': ' : ':') + r);
        r = 0 === v.length ? '{}' : h ? '{\n' + h + v.join(',\n' +
        h) + '\n' + z + '}' : '{' + v.join(',') + '}';
        h = z;
        return r
  ...
  'function' !== typeof JSON.parse && (JSON.parse = function (e, f) {
    ...
    if (/^[\],:{}\s]*$/.test(e.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, '@').replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, ']').replace(/(?:^|:|,)(?:\s*\[)+/g, ''))) return n = eval('(' + e + ')'),
    'function' === typeof f ? h({
      '': n
    }, '')  : n;
