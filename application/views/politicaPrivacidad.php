  ...
  <div class="container">
    ...
    <div class="text">
      <p>El presente Política de Privacidad establece los términos en que
        Totocalzado usa y protege la información que es proporcionada por sus
        ...
        se empleará de acuerdo con los términos de este documento.
      ...
      <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor
        ...
        de nuestro sitio con ofertas especiales, nuevos productos y otra información
      ...
      <p>Totocalzado está altamente comprometido para cumplir con el compromiso
      ...
      <h3>Cookies</h3>
      <p>Una cookie se refiere a un fichero que es enviado con la finalidad de
        solicitar permiso para almacenarse en su ordenador, al aceptar dicho
        fichero se crea y la cookie sirve entonces para tener información respecto
      ...
      <p>
        ...
        para análisis estadístico y después la información se elimina de forma permanente.
        Usted puede eliminar las cookies en cualquier momento desde su ordenador.
        Sin embargo las cookies ayudan a proporcionar un mejor servicio de los
        sitios web, estás no dan acceso a información de su ordenador ni de usted,
        a menos de que usted así lo quiera y la proporcione directamente,
        visitas a una web . Usted puede aceptar o negar el uso de cookies, sin
        embargo la mayoría de navegadores aceptan cookies automáticamente pues
        sirve para tener un mejor servicio web. También usted puede cambiar la
        configuración de su ordenador para declinar las cookies. Si se declinan
        es posible que no pueda utilizar algunos de nuestros servicios.
      </p>
      <h3>Enlaces a Terceros</h3>
      <p>Este sitio web pudiera contener en laces a otros sitios que pudieran
        ser de su interés. Una vez que usted de clic en estos enlaces y abandone
        nuestra página, ya no tenemos control sobre al sitio al que es redirigido
        y por lo tanto no somos responsables de los términos o privacidad ni de
        la protección de sus datos en esos otros sitios terceros. Dichos sitios
      ...
      <p>En cualquier momento usted puede restringir la recopilación o el uso
      ...
      <p>Totocalzado Se reserva el derecho de cambiar los términos de la presente
